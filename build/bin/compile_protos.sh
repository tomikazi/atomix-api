...
# Compile membership proto files
protoc -I=$proto_imports --doc_out=docs  --doc_opt=markdown,membership.md  --gogofaster_out=import_path=atomix/membership,plugins=grpc:proto proto/atomix/membership/*.proto
protoc -I=$proto_imports --doc_out=docs  --doc_opt=markdown,partition.md  --gogofaster_out=import_path=atomix/partition,plugins=grpc:proto proto/atomix/partition/*.proto
...
gossip_import_map="Mgoogle/protobuf/duration.proto=github.com/gogo/protobuf/types,Mgoogle/protobuf/timestamp.proto=github.com/gogo/protobuf/types,Matomix/primitive/primitive.proto=github.com/atomix/api/proto/atomix/primitive,Matomix/protocol/protocol.proto=github.com/atomix/api/proto/atomix/protocol,Matomix/membership/membership.proto=github.com/atomix/api/proto/atomix/membership,Matomix/gossip/headers/headers.proto=github.com/atomix/api/proto/atomix/gossip/headers"
...
pb_import_map="Mgoogle/protobuf/duration.proto=github.com/gogo/protobuf/types,Mgoogle/protobuf/timestamp.proto=github.com/gogo/protobuf/types,Matomix/primitive/primitive.proto=github.com/atomix/api/proto/atomix/primitive,Matomix/protocol/protocol.proto=github.com/atomix/api/proto/atomix/protocol,Matomix/partition/partition.proto=github.com/atomix/api/proto/atomix/partition,Matomix/pb/headers/headers.proto=github.com/atomix/api/proto/atomix/pb/headers"
