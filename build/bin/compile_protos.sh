...
protoc -I=$proto_path --doc_out=docs  --doc_opt=markdown,broker.md    proto/atomix/management/broker/*.proto
...
protoc -I=$proto_path --gogofaster_out=$go_import_paths,import_path=github.com/atomix/api/go/atomix/management/broker,plugins=grpc:go proto/atomix/management/broker/*.proto
