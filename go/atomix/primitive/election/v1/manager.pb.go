...
type OpenSessionRequest struct {
	Options LeaderElectionOptions `protobuf:"bytes,1,opt,name=options,proto3" json:"options"`
}
...
func (m *OpenSessionRequest) GetOptions() LeaderElectionOptions {
	if m != nil {
		return m.Options
	}
...
func (m *LeaderElectionOptions) Reset()         { *m = LeaderElectionOptions{} }
func (m *LeaderElectionOptions) String() string { return proto.CompactTextString(m) }
func (*LeaderElectionOptions) ProtoMessage()    {}
func (*LeaderElectionOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_77b7c3084f9304e6, []int{2}
}
func (m *LeaderElectionOptions) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LeaderElectionOptions) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LeaderElectionOptions.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LeaderElectionOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LeaderElectionOptions.Merge(m, src)
}
func (m *LeaderElectionOptions) XXX_Size() int {
	return m.Size()
}
func (m *LeaderElectionOptions) XXX_DiscardUnknown() {
	xxx_messageInfo_LeaderElectionOptions.DiscardUnknown(m)
}

var xxx_messageInfo_LeaderElectionOptions proto.InternalMessageInfo
...
func (*CloseSessionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_77b7c3084f9304e6, []int{4}
}
...
func init() {
	...
	proto.RegisterType((*LeaderElectionOptions)(nil), "atomix.primitive.election.v1.LeaderElectionOptions")
...
var fileDescriptor_77b7c3084f9304e6 = []byte{
	...
	,
}
...
func (m *LeaderElectionOptions) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LeaderElectionOptions) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LeaderElectionOptions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *LeaderElectionOptions) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LeaderElectionOptions) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LeaderElectionOptions: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LeaderElectionOptions: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
