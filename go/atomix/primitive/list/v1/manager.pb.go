...
type OpenSessionRequest struct {
	Options ListOptions `protobuf:"bytes,1,opt,name=options,proto3" json:"options"`
}
...
func (m *OpenSessionRequest) GetOptions() ListOptions {
	if m != nil {
		return m.Options
	}
	return ListOptions{}
...
func init() {
	...
	proto.RegisterType((*ListOptions)(nil), "atomix.primitive.list.v1.ListOptions")
...
var fileDescriptor_4e25147e7a0e64ff = []byte{
	...
	0xe0, 0x36, 0x52, 0xd5, 0xc3, 0xe5, 0x32, 0x3d, 0x9f, 0xcc, 0xe2, 0x12, 0x7f, 0x88, 0x62, 0x27,
	...
	0x6c, 0xe0, 0x54, 0x61, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xfa, 0x1f, 0x11, 0xd3, 0xb1, 0x02,
	0x00, 0x00,
}
