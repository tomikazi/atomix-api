...
@javax.annotation.Generated(
    ...
    comments = "Source: atomix/protocol/v1/config.proto")
public final class ProtocolConfigServiceGrpc {

  private ProtocolConfigServiceGrpc() {}

  public static final String SERVICE_NAME = "atomix.protocol.v1.ProtocolConfigService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<atomix.protocol.v1.Config.UpdateConfigRequest,
      atomix.protocol.v1.Config.UpdateConfigResponse> getUpdateConfigMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UpdateConfig",
      requestType = atomix.protocol.v1.Config.UpdateConfigRequest.class,
      responseType = atomix.protocol.v1.Config.UpdateConfigResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<atomix.protocol.v1.Config.UpdateConfigRequest,
      atomix.protocol.v1.Config.UpdateConfigResponse> getUpdateConfigMethod() {
    io.grpc.MethodDescriptor<atomix.protocol.v1.Config.UpdateConfigRequest, atomix.protocol.v1.Config.UpdateConfigResponse> getUpdateConfigMethod;
      ...
      synchronized (ProtocolConfigServiceGrpc.class) {
        if ((getUpdateConfigMethod = ProtocolConfigServiceGrpc.getUpdateConfigMethod) == null) {
          ProtocolConfigServiceGrpc.getUpdateConfigMethod = getUpdateConfigMethod =
              io.grpc.MethodDescriptor.<atomix.protocol.v1.Config.UpdateConfigRequest, atomix.protocol.v1.Config.UpdateConfigResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UpdateConfig"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  atomix.protocol.v1.Config.UpdateConfigRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  atomix.protocol.v1.Config.UpdateConfigResponse.getDefaultInstance()))
  ...
  public static abstract class ProtocolConfigServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void updateConfig(atomix.protocol.v1.Config.UpdateConfigRequest request,
        io.grpc.stub.StreamObserver<atomix.protocol.v1.Config.UpdateConfigResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                atomix.protocol.v1.Config.UpdateConfigRequest,
                atomix.protocol.v1.Config.UpdateConfigResponse>(
  ...
  public static final class ProtocolConfigServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ProtocolConfigServiceBlockingStub> {
     ...
     * </pre>
     */
    public atomix.protocol.v1.Config.UpdateConfigResponse updateConfig(atomix.protocol.v1.Config.UpdateConfigRequest request) {
  ...
  public static final class ProtocolConfigServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ProtocolConfigServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<atomix.protocol.v1.Config.UpdateConfigResponse> updateConfig(
        atomix.protocol.v1.Config.UpdateConfigRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_UPDATE_CONFIG:
          serviceImpl.updateConfig((atomix.protocol.v1.Config.UpdateConfigRequest) request,
              (io.grpc.stub.StreamObserver<atomix.protocol.v1.Config.UpdateConfigResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ProtocolConfigServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return atomix.protocol.v1.Config.getDescriptor();
    }
