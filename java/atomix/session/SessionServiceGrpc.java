...
@javax.annotation.Generated(
    ...
    comments = "Source: atomix/session/session.proto")
public final class SessionServiceGrpc {

  private SessionServiceGrpc() {}

  public static final String SERVICE_NAME = "atomix.session.SessionService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<atomix.session.Session.OpenSessionRequest,
      atomix.session.Session.OpenSessionResponse> getOpenSessionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "OpenSession",
      requestType = atomix.session.Session.OpenSessionRequest.class,
      responseType = atomix.session.Session.OpenSessionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<atomix.session.Session.OpenSessionRequest,
      atomix.session.Session.OpenSessionResponse> getOpenSessionMethod() {
    io.grpc.MethodDescriptor<atomix.session.Session.OpenSessionRequest, atomix.session.Session.OpenSessionResponse> getOpenSessionMethod;
      ...
      synchronized (SessionServiceGrpc.class) {
        if ((getOpenSessionMethod = SessionServiceGrpc.getOpenSessionMethod) == null) {
          SessionServiceGrpc.getOpenSessionMethod = getOpenSessionMethod =
              io.grpc.MethodDescriptor.<atomix.session.Session.OpenSessionRequest, atomix.session.Session.OpenSessionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "OpenSession"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  atomix.session.Session.OpenSessionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  atomix.session.Session.OpenSessionResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<atomix.session.Session.KeepAliveRequest,
      atomix.session.Session.KeepAliveResponse> getKeepAliveMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "KeepAlive",
      requestType = atomix.session.Session.KeepAliveRequest.class,
      responseType = atomix.session.Session.KeepAliveResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<atomix.session.Session.KeepAliveRequest,
      atomix.session.Session.KeepAliveResponse> getKeepAliveMethod() {
    io.grpc.MethodDescriptor<atomix.session.Session.KeepAliveRequest, atomix.session.Session.KeepAliveResponse> getKeepAliveMethod;
    if ((getKeepAliveMethod = SessionServiceGrpc.getKeepAliveMethod) == null) {
      synchronized (SessionServiceGrpc.class) {
        if ((getKeepAliveMethod = SessionServiceGrpc.getKeepAliveMethod) == null) {
          SessionServiceGrpc.getKeepAliveMethod = getKeepAliveMethod =
              io.grpc.MethodDescriptor.<atomix.session.Session.KeepAliveRequest, atomix.session.Session.KeepAliveResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "KeepAlive"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  atomix.session.Session.KeepAliveRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  atomix.session.Session.KeepAliveResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<atomix.session.Session.CloseSessionRequest,
      atomix.session.Session.CloseSessionResponse> getCloseSessionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CloseSession",
      requestType = atomix.session.Session.CloseSessionRequest.class,
      responseType = atomix.session.Session.CloseSessionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<atomix.session.Session.CloseSessionRequest,
      atomix.session.Session.CloseSessionResponse> getCloseSessionMethod() {
    io.grpc.MethodDescriptor<atomix.session.Session.CloseSessionRequest, atomix.session.Session.CloseSessionResponse> getCloseSessionMethod;
      ...
      synchronized (SessionServiceGrpc.class) {
        if ((getCloseSessionMethod = SessionServiceGrpc.getCloseSessionMethod) == null) {
          SessionServiceGrpc.getCloseSessionMethod = getCloseSessionMethod =
              io.grpc.MethodDescriptor.<atomix.session.Session.CloseSessionRequest, atomix.session.Session.CloseSessionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CloseSession"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  atomix.session.Session.CloseSessionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  atomix.session.Session.CloseSessionResponse.getDefaultInstance()))
  ...
  public static abstract class SessionServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void openSession(atomix.session.Session.OpenSessionRequest request,
        io.grpc.stub.StreamObserver<atomix.session.Session.OpenSessionResponse> responseObserver) {
     ...
     * </pre>
     */
    public void keepAlive(atomix.session.Session.KeepAliveRequest request,
        io.grpc.stub.StreamObserver<atomix.session.Session.KeepAliveResponse> responseObserver) {
     ...
     * </pre>
     */
    public void closeSession(atomix.session.Session.CloseSessionRequest request,
        io.grpc.stub.StreamObserver<atomix.session.Session.CloseSessionResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                atomix.session.Session.OpenSessionRequest,
                atomix.session.Session.OpenSessionResponse>(
                  this, METHODID_OPEN_SESSION)))
          .addMethod(
            getKeepAliveMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                atomix.session.Session.KeepAliveRequest,
                atomix.session.Session.KeepAliveResponse>(
                  this, METHODID_KEEP_ALIVE)))
          .addMethod(
            getCloseSessionMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                atomix.session.Session.CloseSessionRequest,
                atomix.session.Session.CloseSessionResponse>(
  ...
  public static final class SessionServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SessionServiceBlockingStub> {
     ...
     * </pre>
     */
    public atomix.session.Session.OpenSessionResponse openSession(atomix.session.Session.OpenSessionRequest request) {
     ...
     * </pre>
     */
    public atomix.session.Session.KeepAliveResponse keepAlive(atomix.session.Session.KeepAliveRequest request) {
      return blockingUnaryCall(
     ...
     * </pre>
     */
    public atomix.session.Session.CloseSessionResponse closeSession(atomix.session.Session.CloseSessionRequest request) {
      return blockingUnaryCall(
  ...
  public static final class SessionServiceFutureStub extends io.grpc.stub.AbstractFutureStub<SessionServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<atomix.session.Session.OpenSessionResponse> openSession(
        atomix.session.Session.OpenSessionRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<atomix.session.Session.KeepAliveResponse> keepAlive(
        atomix.session.Session.KeepAliveRequest request) {
      return futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<atomix.session.Session.CloseSessionResponse> closeSession(
        atomix.session.Session.CloseSessionRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_OPEN_SESSION:
          serviceImpl.openSession((atomix.session.Session.OpenSessionRequest) request,
              (io.grpc.stub.StreamObserver<atomix.session.Session.OpenSessionResponse>) responseObserver);
          break;
        case METHODID_KEEP_ALIVE:
          serviceImpl.keepAlive((atomix.session.Session.KeepAliveRequest) request,
              (io.grpc.stub.StreamObserver<atomix.session.Session.KeepAliveResponse>) responseObserver);
          break;
        case METHODID_CLOSE_SESSION:
          serviceImpl.closeSession((atomix.session.Session.CloseSessionRequest) request,
              (io.grpc.stub.StreamObserver<atomix.session.Session.CloseSessionResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SessionServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return atomix.session.Session.getDescriptor();
    }
