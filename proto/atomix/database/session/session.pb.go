...
// source: atomix/database/session/session.proto
...
func (*OpenSessionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_32b4fc70a47aa6e6, []int{0}
}
...
func (*OpenSessionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_32b4fc70a47aa6e6, []int{1}
}
...
func (*KeepAliveRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_32b4fc70a47aa6e6, []int{2}
}
...
func (*KeepAliveResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_32b4fc70a47aa6e6, []int{3}
}
...
func (*CloseSessionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_32b4fc70a47aa6e6, []int{4}
}
...
func (*CloseSessionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_32b4fc70a47aa6e6, []int{5}
}
...
func init() {
	proto.RegisterType((*OpenSessionRequest)(nil), "atomix.database.session.OpenSessionRequest")
	proto.RegisterType((*OpenSessionResponse)(nil), "atomix.database.session.OpenSessionResponse")
	proto.RegisterType((*KeepAliveRequest)(nil), "atomix.database.session.KeepAliveRequest")
	proto.RegisterType((*KeepAliveResponse)(nil), "atomix.database.session.KeepAliveResponse")
	proto.RegisterType((*CloseSessionRequest)(nil), "atomix.database.session.CloseSessionRequest")
	proto.RegisterType((*CloseSessionResponse)(nil), "atomix.database.session.CloseSessionResponse")
}

func init() {
	proto.RegisterFile("atomix/database/session/session.proto", fileDescriptor_32b4fc70a47aa6e6)
}

var fileDescriptor_32b4fc70a47aa6e6 = []byte{
	// 383 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *sessionServiceClient) OpenSession(ctx context.Context, in *OpenSessionRequest, opts ...grpc.CallOption) (*OpenSessionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/atomix.database.session.SessionService/OpenSession", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionServiceClient) KeepAlive(ctx context.Context, in *KeepAliveRequest, opts ...grpc.CallOption) (*KeepAliveResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/atomix.database.session.SessionService/KeepAlive", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionServiceClient) CloseSession(ctx context.Context, in *CloseSessionRequest, opts ...grpc.CallOption) (*CloseSessionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/atomix.database.session.SessionService/CloseSession", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SessionService_OpenSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/atomix.database.session.SessionService/OpenSession",
	}
...
func _SessionService_KeepAlive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/atomix.database.session.SessionService/KeepAlive",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SessionService_CloseSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/atomix.database.session.SessionService/CloseSession",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _SessionService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "atomix.database.session.SessionService",
	...
	Metadata: "atomix/database/session/session.proto",
}
