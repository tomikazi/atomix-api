...
// source: atomix/gossip/headers/headers.proto

package headers

import (
	fmt "fmt"
	membership "github.com/atomix/api/proto/atomix/membership"
...
type MessageHeader struct {
	...
	Source    membership.MemberId   `protobuf:"bytes,3,opt,name=source,proto3" json:"source"`
}
...
func (*MessageHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_3086f354f91f39c3, []int{0}
}
...
func (m *MessageHeader) GetProtocol() protocol.ProtocolId {
	if m != nil {
		return m.Protocol
	}
...
func (m *MessageHeader) GetPrimitive() primitive.PrimitiveId {
	if m != nil {
		return m.Primitive
	}
...
func (m *MessageHeader) GetSource() membership.MemberId {
	if m != nil {
		return m.Source
	}
...
func init() {
	proto.RegisterType((*MessageHeader)(nil), "atomix.gossip.headers.MessageHeader")
}

func init() {
	proto.RegisterFile("atomix/gossip/headers/headers.proto", fileDescriptor_3086f354f91f39c3)
}

var fileDescriptor_3086f354f91f39c3 = []byte{
	// 248 bytes of a gzipped FileDescriptorProto
	,
}
