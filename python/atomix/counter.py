...
# sources: atomix/counter/counter.proto
...
class CounterServiceStub(betterproto.ServiceStub):
    ...
    async def create(
        ...
        return await self._unary_unary(
            "/atomix.counter.CounterService/Create", request, CreateResponse,
        )
    ...
    async def close(
        ...
        return await self._unary_unary(
            "/atomix.counter.CounterService/Close", request, CloseResponse,
        )

    async def set(
        self, *, header: Optional[headers.RequestHeader] = None, value: int = 0
    ) -> SetResponse:
        ...
        return await self._unary_unary(
            "/atomix.counter.CounterService/Set", request, SetResponse,
        )
    ...
    async def get(
        ...
        return await self._unary_unary(
            "/atomix.counter.CounterService/Get", request, GetResponse,
        )

    async def increment(
        self, *, header: Optional[headers.RequestHeader] = None, delta: int = 0
    ) -> IncrementResponse:
        ...
        return await self._unary_unary(
            "/atomix.counter.CounterService/Increment", request, IncrementResponse,
        )
    ...
    async def decrement(
        ...
        return await self._unary_unary(
            "/atomix.counter.CounterService/Decrement", request, DecrementResponse,
        )
    ...
    async def check_and_set(
        ...
        *,
        ...
        return await self._unary_unary(
            "/atomix.counter.CounterService/CheckAndSet", request, CheckAndSetResponse,
        )
