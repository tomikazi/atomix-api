...
# sources: atomix/management/broker/broker.proto
...
class BrokerStub(betterproto.ServiceStub):
    async def register_primitive(
        ...
        return await self._unary_unary(
            "/atomix.management.broker.Broker/RegisterPrimitive",
            request,
            RegisterPrimitiveResponse,
        )
    ...
    async def unregister_primitive(
        ...
        return await self._unary_unary(
            "/atomix.management.broker.Broker/UnregisterPrimitive",
            request,
            UnregisterPrimitiveResponse,
        )
    ...
    async def lookup_primitive(
        ...
        return await self._unary_unary(
            "/atomix.management.broker.Broker/LookupPrimitive",
            request,
            LookupPrimitiveResponse,
        )
