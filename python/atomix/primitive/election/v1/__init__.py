...
# sources: atomix/primitive/election/v1/primitive.proto, atomix/primitive/election/v1/session.proto
...
@dataclass(eq=False, repr=False)
class LeaderElectionSessionOptions(betterproto.Message):
    pass
...
class LeaderElectionSessionStub(betterproto.ServiceStub):
    """LeaderElection is a service for a leader election primitive"""
    ...
    async def open_session(
        ...
        return await self._unary_unary(
            "/atomix.primitive.election.v1.LeaderElectionSession/OpenSession",
            request,
            OpenSessionResponse,
        )
    ...
    async def close_session(self, *, session_id: str = "") -> "CloseSessionResponse":
        ...
        return await self._unary_unary(
            "/atomix.primitive.election.v1.LeaderElectionSession/CloseSession",
            request,
