...
# sources: atomix/primitive/list/v1/primitive.proto, atomix/primitive/list/v1/session.proto
...
class ListSessionStub(betterproto.ServiceStub):
    """List is a service for a list primitive"""
    ...
    async def open_session(
        ...
        return await self._unary_unary(
            "/atomix.primitive.list.v1.ListSession/OpenSession",
            request,
            OpenSessionResponse,
        )
    ...
    async def close_session(self, *, session_id: str = "") -> "CloseSessionResponse":
        ...
        return await self._unary_unary(
            "/atomix.primitive.list.v1.ListSession/CloseSession",
            request,
