...
# sources: atomix/storage/list/list.proto
...
class ListServiceStub(betterproto.ServiceStub):
    ...
    async def create(
        ...
        return await self._unary_unary(
            "/atomix.storage.list.ListService/Create", request, CreateResponse,
        )
    ...
    async def close(
        ...
        return await self._unary_unary(
            "/atomix.storage.list.ListService/Close", request, CloseResponse,
        )
    ...
    async def size(
        ...
        return await self._unary_unary(
            "/atomix.storage.list.ListService/Size", request, SizeResponse,
        )
    ...
    async def contains(
        ...
        return await self._unary_unary(
            "/atomix.storage.list.ListService/Contains", request, ContainsResponse,
        )
    ...
    async def append(
        ...
        return await self._unary_unary(
            "/atomix.storage.list.ListService/Append", request, AppendResponse,
        )
    ...
    async def insert(
        ...
        *,
        ...
        return await self._unary_unary(
            "/atomix.storage.list.ListService/Insert", request, InsertResponse,
        )
    ...
    async def get(
        ...
        return await self._unary_unary(
            "/atomix.storage.list.ListService/Get", request, GetResponse,
        )
    ...
    async def set(
        ...
        *,
        ...
        return await self._unary_unary(
            "/atomix.storage.list.ListService/Set", request, SetResponse,
        )
    ...
    async def remove(
        ...
        return await self._unary_unary(
            "/atomix.storage.list.ListService/Remove", request, RemoveResponse,
        )
    ...
    async def clear(
        ...
        return await self._unary_unary(
            "/atomix.storage.list.ListService/Clear", request, ClearResponse,
        )
    ...
    async def events(
        ...
        async for response in self._unary_stream(
            "/atomix.storage.list.ListService/Events", request, EventResponse,
        ):
            yield response
    ...
    async def iterate(
        ...
        async for response in self._unary_stream(
            "/atomix.storage.list.ListService/Iterate", request, IterateResponse,
        ):
            yield response
