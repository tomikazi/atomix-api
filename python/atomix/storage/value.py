...
# sources: atomix/storage/value/value.proto
...
class ValueServiceStub(betterproto.ServiceStub):
    ...
    async def create(
        ...
        return await self._unary_unary(
            "/atomix.storage.value.ValueService/Create", request, CreateResponse,
        )
    ...
    async def close(
        ...
        return await self._unary_unary(
            "/atomix.storage.value.ValueService/Close", request, CloseResponse,
        )
    ...
    async def set(
        ...
        *,
        ...
        return await self._unary_unary(
            "/atomix.storage.value.ValueService/Set", request, SetResponse,
        )
    ...
    async def get(
        ...
        return await self._unary_unary(
            "/atomix.storage.value.ValueService/Get", request, GetResponse,
        )
    ...
    async def events(
        ...
        async for response in self._unary_stream(
            "/atomix.storage.value.ValueService/Events", request, EventResponse,
        ):
            yield response
